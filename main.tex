...
By default perf records sample at **both** user and kernel levels using cycles events with average rate of 1000 samples/sec. We can adjust both frequency of collection samples and period i.e collecting sample every Nth occurence of an event by passing -F and -c flag respectively to perf record.
